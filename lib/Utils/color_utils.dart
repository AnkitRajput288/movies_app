...
class ColorUtils {
  ...
  // Random Color Generator - Ankit Code - Start
  final List<Color> circleColors = [
    const Color(0xfFFedb7b7),
    const Color(0xfFFffe0fb),
    const Color(0xfFFff6f61),
    const Color(0xfFFfffebb),
    const Color(0xfFFff0080),
    const Color(0xfFF65af44),
    const Color(0xfFFc7afd0),
    const Color(0xfFFcccccc),
    const Color(0xfFF0cc375),
    const Color(0xfFF00C5CD),
    const Color(0xfFF00FFCC),
    const Color(0xfFF20B2AA),
    const Color(0xfFF8E236B),
    const Color(0xfFFBFEFFF),
    const Color(0xfFFC0D9D9),
    const Color(0xfFFC77826),
    const Color(0xfFFCAE1FF),
    const Color(0xfFFE6E8FA),
    const Color(0xfFFEAB5C5),
  ];

  final List<Color> genreColors = [
    const Color(0xfFFef4746),
    const Color(0xfFF435849),
    const Color(0xfFFffc803),
    const Color(0xfFF867c71),
    const Color(0xfFFd3ccc5),
    const Color(0xfFFd8c493),
    const Color(0xfFFb5b0b0),
    const Color(0xfFFbda4a3),
    const Color(0xfFF272621),
    const Color(0xfFF7c7e70),
    const Color(0xfFFa8c1c5),
    const Color(0xfFF363636),
    const Color(0xfFF262c3a),
    const Color(0xfFFd2c1a2),
    const Color(0xfFF97958b),
    const Color(0xfFFae5c46),
    const Color(0xfFF90757a),
    const Color(0xfFF214948),
    const Color(0xfFFd3cdbd),
    const Color(0xfFFe5a5ad),
    const Color(0xfFFbebab8),
    const Color(0xfFFeea3bd),
    const Color(0xfFF78795e),
    const Color(0xfFF8f432e),
    const Color(0xfFF623722),
    const Color(0xfFFd98f70),
    const Color(0xfFFf9c01b),
    const Color(0xfFFcec34f),
    const Color(0xfFF5d7d49),
    const Color(0xfFFbbb9b6),
    const Color(0xfFF9d735e),
    const Color(0xfFFb38a74),
    const Color(0xfFFbfada9),
    const Color(0xfFF847151),
    const Color(0xfFFc1b9b2),
    const Color(0xfFFcdb49e),
    const Color(0xfFF263f55),
    const Color(0xfFFb8c7ce),
    const Color(0xfFF9e8556),
    const Color(0xfFF767b74),
    const Color(0xfFFa6b0b1),
    const Color(0xfFF364648),
    const Color(0xfFF5d4610),
    const Color(0xfFFafaca2),
    const Color(0xfFF5c5c5c),
    const Color(0xfFFe2c4ce),
    const Color(0xfFFebb7a1),
    const Color(0xfFF3d768a),
    const Color(0xfFFfe83a6),
    const Color(0xfFFaa7b8b),
    const Color(0xfFFdbc3b4),
    const Color(0xfFFcfa894),
    const Color(0xfFF9a6a44),
    const Color(0xfFFdac4a9),
    const Color(0xfFFc2c2c2),
    const Color(0xfFF362608),
    const Color(0xfFFbdb0a5),
    const Color(0xfFF06a9b4),
    const Color(0xfFFd2cdd5),
    const Color(0xfFF84c9d8),
    const Color(0xfFF7ab973),
    const Color(0xfFFbe8f97),
    const Color(0xfFF919191),
    const Color(0xfFFd0c9d2),
    const Color(0xfFF806f57),
    const Color(0xfFF6b6961),
    const Color(0xfFFb2988e),
    const Color(0xfFFc2c3b8),
    const Color(0xfFF2d212b),
    const Color(0xfFF858181),
    const Color(0xfFFb0a8a8),
    const Color(0xfFFdea586),
    const Color(0xfFF8a7665),
    const Color(0xfFFffaec9),
    const Color(0xfFFc0a834),
    const Color(0xfFF192c3d),
  ];

  final List<Color> shimmerLoadingColors = [
    const Color(0xfFFE0E0E0),
    const Color(0xfFFE0E0E0),
    const Color(0xfFFEAF1F1),
    const Color(0xfFFEAEDEA),
    const Color(0xfFFE2E9E9),
    const Color(0xfFFd0c9d2),
    const Color(0xfFFd3cdbd),
    const Color(0xfFFE8E6E9),
    const Color(0xfFFE3E9E9),
    const Color(0xfFFE0E0E0),
    const Color(0xfFFc1b9b2),
    const Color(0xfFFDADADA),
    const Color(0xfFFE1E1E1),
    const Color(0xfFFd0c9d2),
    const Color(0xfFFEAEDEA),
    const Color(0xfFFEAF1F1),
    const Color(0xfFFd3cdbd),
...
// Random Color Generator - Ankit Code - END
